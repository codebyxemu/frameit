...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://frameit.com/" className="flex items-center">
      <img src="https://github.com/codebyxemu/frameit/blob/master/public/zeppelin-black.png?raw=true" className="h-8 mr-3" alt="Flowbite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Frame It</span>
  </a>
  <div className="flex items-center md:order-2">
      <button type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span className="sr-only">Open user menu</span>
        <img className="w-8 h-8 rounded-full" src="/zeppelin-black.png" alt="user photo"></img>
      </button>
      <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        <div className="px-4 py-3">
          <span className="block text-sm text-gray-900 dark:text-white">Demo User</span>
          <span className="block text-sm  text-gray-500 truncate dark:text-gray-400">demo@frameit.zeppelin.lol</span>
        </div>
        <ul className="py-2" aria-labelledby="user-menu-button">
          ...
          <li>
            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Support</a>
          </li>
          <li>
